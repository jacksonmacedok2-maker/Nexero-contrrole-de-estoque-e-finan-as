...
import { Building2, Receipt, Users, ShoppingBag, Box, Store, Wallet, Bell, Link2, Monitor, ChevronRight, Save, CheckCircle2, UserPlus, Trash2, Edit2, X, Lock } from 'lucide-react';
import { useAppSettings, ThemeMode } from '../contexts/AppSettingsContext';
import { Language } from '../i18n/translations';
import { User, UserRole, Permission } from '../types';
import { generateId } from '../utils/helpers';

type SectionType = 'company' | 'fiscal' | 'users' | 'commercial' | 'inventory' | 'pos' | 'finance' | 'notifications' | 'integrations' | 'appearance';

const Settings: React.FC = () => {
  const [activeSection, setActiveSection] = useState<SectionType>('appearance');
  const { settings, updateSettings, t } = useAppSettings();
  
  // Local state for the appearance form
...
// --- HELPERS RE-IMPLEMENTED FOR THIS FILE ---
